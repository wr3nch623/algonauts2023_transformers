...
verbose = 1
plot_figs = 0  # Cambiato da 1 a 0 per disabilitare la generazione automatica del grafico
...
for subj in [1]: # range(1,9):
    ...
    test_save_dir = '../temp/results/detr_dino_'+ str(lay)+ '_' + readout_res + '_16/' + str(args.subj)  
    ...
    lh_corr.append(lh_mean_roi_correlation[0:])
    rh_corr.append(rh_mean_roi_correlation[0:])
...
print(lh_roi_correlation)
print("spazio")
print(lh_corr)

np.save('lh_corr.npy', lh_corr)
np.save('rh_corr.npy', rh_corr)